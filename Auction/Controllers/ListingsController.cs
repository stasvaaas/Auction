    ...
    public class ListingsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? pageNumber, string searchString)
        {
            ...
            if(!string.IsNullOrEmpty(searchString))
            {
                ...
                return View(await PaginatedList<Listing>.CreateAsync(applicationDbContext.Where(x => x.IsSold).AsNoTracking(), pageNumber ??1, pageSize));
            }
            return View(await PaginatedList<Listing>.CreateAsync(applicationDbContext.Where(x => x.IsSold == false).AsNoTracking(), pageNumber ?? 1, pageSize));
        }
        ...
        public async Task<IActionResult> MyListings(int? pageNumber)
        {
            ...
            return View("Index", await PaginatedList<Listing>.CreateAsync(applicationDbContext.Where(x => x.IdentityUserId == User.FindFirstValue(ClaimTypes.NameIdentifier)).AsNoTracking(), pageNumber ?? 1, pageSize)); 
        }
        ...
        public async Task<IActionResult> MyBids(int? pageNumber)
        {
            ...
            return View( await PaginatedList<Bid>.CreateAsync(applicationDbContext.Where(x => x.IdentityUserId == User.FindFirstValue(ClaimTypes.NameIdentifier)).AsNoTracking(), pageNumber ?? 1, pageSize));
        }
